...
type DynamicDeployFieldsProps<TFieldValues extends FieldValues> = {
  ...
  isEditing: boolean;
  /** Show optional vars in the main list instead of Advanced Options. */
  showOptionalInline?: boolean;
  /** Show read-only values in plain text (no eye/mask toggle). */
    ...
    <FormField
      ...
      render={({ field, fieldState }) => (
        ...
        >
          ...
          <FormMessage
            className="form-field-error deploy-var-error"
            role="alert"
          />
        </FormItem>
      )}
...
export function DynamicDeployFields<TFieldValues extends FieldValues>({
  ...
  const inlineVariables = showOptionalInline
    ? [...requiredVariables, ...optional]
    : requiredVariables;
    ...
    <div className="deploy-vars-panel">
      <section className="deploy-vars-section">
        <header className="deploy-vars-section-header">
          ...
          <p>
            {showOptionalInline
              ? "Values extracted from your compose file."
        ...
        <DeployVariableList
          ...
          isEditing={isEditing}
          isRequired={!showOptionalInline}
          alwaysRevealValues={alwaysRevealValues}
        />
      </section>

      {!showOptionalInline && optional.length > 0 ? (
