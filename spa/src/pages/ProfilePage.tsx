...
function GeneralDetailsCard() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(getMutationErrorMessage(err, "Failed to update profile."));
    }
  }
          ...
          <div className="profile-avatar-upload">
            <div className="profile-avatar-preview">
              {profilePicture ? (
                ...
                getUserInitials({ ...user, firstName, lastName })
              )}
            </div>
            <input
              ref={fileInputRef}
...
function ChangePasswordCard() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(getMutationErrorMessage(err, "Failed to change password."));
    }
  }
...
function OrganizationCard() {
  ...
  useEffect(() => {
    ...
    setOrgLogo(user.organization.logo);
  }, [user]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(
        getMutationErrorMessage(err, "Failed to update organization."),
      );
    }
  }
