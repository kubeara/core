...
export class DeploymentsController {
    ...
    async getDeployment(@Param('deploymentId') deploymentId: string) {
        ...
        const environment_variables = await this.deploymentsService.listEnvironmentVariables(
            deploymentId,
            { maskSecrets: true },
        );
    ...
    async listEnvironmentVariables(@Param('deploymentId') deploymentId: string) {
        return this.deploymentsService.listEnvironmentVariables(deploymentId, { maskSecrets: true });
    }
